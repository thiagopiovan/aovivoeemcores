<?php 
    ...
    if($_GET["n"]==2)
    {
        ...
        $to      = $email;
        $subject = "[AO VIVO] - Confirmação de Doação";
        $message = "Olá <b>".$nome."</b>,<br><br>Agradecemos imensamente sua contribuição de <b>R$".number_format($valor, 2, ",", ".")."</b> para nossa futura sede.<br><br>Atenciosamente,<br><br><b>Projeto Social Ao Vivo e em Cores</b>";
    }
